<?php
/**
 * daftar_pengaduan.php (Petugas)
 * Menampilkan daftar pengaduan yang ditugaskan ke petugas
 */
$page_title = 'Pengaduan Ditugaskan';
...
$sql = "SELECT p.*, k.nama_kategori, u.nama as nama_pelapor
    FROM pengaduan p
    ...
    <div class="card-body">
        <?php if (empty($pengaduan_list)): ?>
            <div class="empty-state">
                <p>Tidak ada pengaduan yang ditugaskan kepada Anda<?= $filter_status ? " dengan status \"{$filter_status}\"" : '' ?>.</p>
            </div>
        <?php else: ?>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/petugas/detail_pengaduan.php?id=<?= $row['id'] ?>" class="btn btn-outline btn-sm">Detail</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
